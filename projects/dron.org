...
:END:
* TODO [#B] [2021-02-24] [[https://unix.stackexchange.com/questions/441575/proper-way-to-use-onfailure-in-systemd/441662#441662][linux - Proper way to use OnFailure in systemd - Unix & Linux Stack Exchange]] :dron:
:PROPERTIES:
