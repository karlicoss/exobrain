...
:PROPERTIES:
:ID:       sndtctrgflsnsbfldrsssrgzlyrgzlyndrd
:END:
...
:PROPERTIES:
:ID:       wdshtwrdsyncthnghsgtsmsrtndrpbxthtsdtchckfrdffrncs
:END:
* [#B] * wildcard                                                  :wildcard:
:PROPERTIES:
:ID:       wldcrd
...
:PROPERTIES:
:ID:       stsgthbcmmchlmrgtbgblbbddlgtbgmprtgtbddbmchlmrgtbg
:END:
...
:PROPERTIES:
:ID:       thktwsprtllyrslvdtlsttxpnbltythghcnslydspppntnwsrs
:END:

** TODO [#C] [2019-02-20] hypothesis/client: The Hypothesis web-based annotation client.
:PROPERTIES:
:ID:       wdhypthssclntthhypthsswbbsdnnttnclnt
:END:
