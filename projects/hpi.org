...
:ID:       rdprtyntgrtns
:END:
** STRT [#B] demo: def need demonstration with Memacs...             :memacs:
:PROPERTIES:
:CREATED:  [2020-04-24]
...
** STRT [#C] expose and connect to observable?               :hpi:observable:
:PROPERTIES:
:CREATED:  [2021-01-14]
:ID:       xpsndcnncttbsrvbl
:END:
https://observablehq.com/@karlicoss/hpi_meets_http
...
:ID:       grfnsgdfrgpsndt
:END:
* TODO [#B] windows compatibility..                                     :hpi:
:PROPERTIES:
:CREATED:  [2021-02-16]
:ID:       wndwscmptblty
:END:
...
That way would be able to easily import and remember lots if tgings. Just need stable ids..
...
* [#B] [2021-02-04] [[https://news.ycombinator.com/item?id=26018187][Apache Arrow 3.0 | Hacker News]] :hpi:
:PROPERTIES:
...
* [#B] [2020-10-31] [[https://pyspread.gitlab.io/][Welcome to pyspread | pyspread]] :hpi:python:spreadsheets:
:PROPERTIES:
